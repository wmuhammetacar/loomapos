...
export const featurePreviewGrid = [
  { title: "Sales Operations", href: "/features/sales/sales", description: "Kasa ve odeme akislari uygulamalarda calisir." },
  { title: "Inventory Management", href: "/features/inventory/inventory", description: "Kritik stok, sayim ve urun hareketleri uygulamalarda yonetilir." },
  { title: "Reporting", href: "/features/reporting/reports", description: "Yonetici raporlari lisansli istemcilerde izlenir." },
  { title: "Staff Management", href: "/features/staff/staff-management", description: "Rol, yetki ve personel yapisi cihaz bazli aktive edilir." },
  { title: "Branch Management", href: "/features/multi-branch/branch-management", description: "Cok subeli rollout ve cihaz limiti plan bazli kurulur." },
  { title: "Online Payment Collection Integration", href: "/features/payments/online-payments", description: "Uzak tahsilat entegrasyonu uygulama operasyonuna baglanir." },
  { title: "Variant Product Management", href: "/features/inventory/product-variants", description: "Beden, renk ve paket varyantlari uygulamalarda islenir." },
  { title: "E-Invoice Integration", href: "/features/e-invoice/e-invoice", description: "Belge akisi ve kurulum rehberi plan bazli sunulur." },
  { title: "Cash Register Integrations", href: "/features/integrations/cash-register-integrations", description: "Mali cihaz baglantilari webde degil istemcide calisir." },
  { title: "Pricing Management", href: "/features/pricing-control/pricing-management", description: "Fiyat katmani webde satilir, operasyon uygulamada kullanilir." },
  { title: "Management Dashboard", href: "/features/admin/admin-control", description: "Karar destek ekranlari masaustu ve mobilde sunulur." }
] as const;
...
export const resellerPortalModules = [
  ...
  { href: "/reseller/portal/leads", label: "Leads" },
  ...
  { href: "/reseller/portal/training", label: "Training" },
...
export const routeTree = [
  ...
  "/features/inventory/product-variants",
  "/features/reporting",
  "/features/reporting/reports",
  "/features/staff",
  "/features/staff/staff-management",
  "/features/multi-branch",
  "/features/multi-branch/branch-management",
  "/features/payments",
  "/features/payments/online-payments",
  "/features/e-invoice",
  "/features/e-invoice/e-invoice",
  "/features/integrations",
  "/features/integrations/cash-register-integrations",
  "/features/pricing-control",
  "/features/pricing-control/pricing-management",
  "/features/admin",
  "/features/admin/admin-control",
  "/compare",
  "/compare/[slug]",
  "/pricing",
  "/download",
